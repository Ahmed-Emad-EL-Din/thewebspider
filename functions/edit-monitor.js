...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        const { id, user_email, url, ai_focus_note, deep_crawl, deep_crawl_depth, requires_login, has_captcha, username, password, captcha_json, email_notifications_enabled, telegram_notifications_enabled, telegram_chat_id } = data;
