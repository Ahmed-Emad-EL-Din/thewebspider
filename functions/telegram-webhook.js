        ...
        if (body.message && body.message.text) {
            ...
            if (text.startsWith('/start ')) {
                ...
                if (token && token.length > 0) {
                    ...
                    if (botToken) {
                        const messageText = "✅ Authentication Successful!\n\nYour Telegram account is now linked to the Web Watcher Dashboard. Your unique Chat ID has been automatically populated.\n\nYou can close this chat and return to the dashboard.";
                ...
                if (botToken) {
                    await fetch(`https://api.telegram.org/bot${botToken}/sendMessage`, {
                        ...
                        body: JSON.stringify({
                            chat_id: chat_id,
                            text: "Welcome to Web Watcher Bot! Start the connection process from the dashboard website to link your account."
                        })
                    });
                }
            }
